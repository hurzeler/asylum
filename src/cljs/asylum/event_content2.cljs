...
(def operation-steel-fences
  {:title "Operation Steel Fences"
   ...
   :content "Your political adviser suggests that militarising the asylym seeker issue can help your popularity and give you an excuse to control the media message.  Operation Steel Fences would hand over control of executing your policy to a military commander and position asylum seekers as an enemy of the state."
